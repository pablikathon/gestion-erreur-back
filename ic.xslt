                            ...
                            <div class="col-lg-6">
                                <div class="text-center my-5">
                                    <img class="d-block mx-auto mb-4"
                                        src="https://upload.wikimedia.org/wikipedia/commons/a/af/ReSharper_Icon.png"
                                        alt="" height="100" />
                                    <h1 class="display-5 fw-bolder text-white mb-2">Resharper
                                        InspectCode Report</h1>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            <xsl:attribute name="data-bs-target">#<xsl:value-of
                                                    select="@Id" /></xsl:attribute>
                    <span>
                                                <xsl:choose>
                                                    <xsl:when test="@Severity = 'SUGGESTION'">
                                                        <xsl:attribute name="class">badge bg-info
                                            text-dark</xsl:attribute>
                                                    </xsl:when>
                                                    <xsl:when test="@Severity = 'WARNING'">
                                                        <xsl:attribute name="class">badge bg-warning
                                            text-dark</xsl:attribute>
                                                    </xsl:when>
