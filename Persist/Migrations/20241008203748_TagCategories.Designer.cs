...
namespace Persist.Migrations
{
    ...
    [Migration("20241008203748_TagCategories")]
    partial class TagCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Persist.Entities.BaseTable.ApplicationEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Persist.Entities.BaseTable.ErrorEntity", b =>
                {
                    b.HasOne("Persist.Entities.BaseTable.ApplicationEntity", "Application")
                        .WithMany()
