    ...
    public partial class addColumnAndRelation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerHaveLicenceToApplications", x => new { x.CustomerId, x.ApplicationId });
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeployedApplication", x => new { x.ServerId, x.ApplicationId, x.CustomerId });
                    table.ForeignKey(
