...
namespace Repositories
{
    public class ApplicationDeployedOnServerRepository : IApplicationDeployedOnServerRepository
    {
        ...
        public async Task<ApplicationDeployedOnServerEntity> AddAsync(
            ApplicationDeployedOnServerEntity deployedApplicationEntity)
        {
        ...
        {
            ApplicationDeployedOnServerEntity? deployedApplication =
                await _context.ApplicationDeployedOnServer.FindAsync(idServer, idApplication);
        ...
        {
            var ads = await _context.ApplicationDeployedOnServer.FindAsync(ApplicationDeployedOnServer.ApplicationId,
                ApplicationDeployedOnServer.CustomerId);
            if (ads != null)
            {
